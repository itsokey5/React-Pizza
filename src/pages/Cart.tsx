...
import PizzaCard from '../components/CardPizzas/PizzaCard';
...
export const Cart: React.FC = () => {
  ...
  const itemsLength = useSelector((state: any) => state.cart.itemsLength );
...
<path d="M11.6666 9.16667V14.1667" stroke="#B6B6B6" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div className="cart__bottom">
              <div className="cart__bottom-details">
                <span> Всего пицц: <b>{itemsLength} шт.</b> </span>
                <span> Сумма заказа: <b>{totalPrice} ₽</b> </span>
              </div>
              <div className="cart__bottom-buttons">
              <Link onClick={() => {window.scrollTo(0, 0);}} to = '/' className="button button--outline button--add go-back-btn">
